...
def traindeeplabv3plus( train_images, train_annotations, val_images, val_annotations):
    ...
    torch.save(model.state_dict(), 'good_deeplabv3plus_final_scaled.pth')
...
traindeeplabv3plus( train_images, train_annotations, val_images, val_annotations)
